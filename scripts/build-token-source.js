 ...
 *   }
 *
 * Runs against the seed dumps committed under tokens/figma-source/, which are
 * regenerated by a Dev Mode / Figma MCP pull from the Variables panel. This step
 * itself is offline and deterministic - no network, no credentials.
 */
