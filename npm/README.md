...
**The themed contract (colour + elevation) is 193 names.** Your full working
vocabulary across every file below is **290**. If you add up every
declaration in this folder you get 986 — that number is not the contract, and the
...
| `themes/light.css` | 193 | yes | yes | Colour + elevation contract, Light Mode. |
| `themes/midnight.css` | 193 | yes | yes | Colour + elevation contract, Midnight Mode. Same names. |
