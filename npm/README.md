...
**The themed contract (colour + elevation) is 200 names.** Your full working
vocabulary across every file below is **297**. If you add up every
declaration in this folder you get 1000 — that number is not the contract, and the
...
| `themes/light.css` | 200 | yes | yes | Colour + elevation contract, Light Mode. |
| `themes/midnight.css` | 200 | yes | yes | Colour + elevation contract, Midnight Mode. Same names. |
