...
**The themed contract (colour + elevation) is 197 names.** Your full working
vocabulary across every file below is **294**. If you add up every
declaration in this folder you get 995 — that number is not the contract, and the
...
| `themes/light.css` | 197 | yes | yes | Colour + elevation contract, Light Mode. |
| `themes/midnight.css` | 197 | yes | yes | Colour + elevation contract, Midnight Mode. Same names. |
