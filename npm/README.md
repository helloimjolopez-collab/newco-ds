...
**The themed contract (colour + elevation) is 149 names.** Your full working
vocabulary across every file below is **262**. If you add up every
declaration in this folder you get 917 — that number is not the contract, and the
...
| `themes/light.css` | 149 | yes | yes | Colour + elevation contract, Light Mode. |
| `themes/midnight.css` | 149 | yes | yes | Colour + elevation contract, Midnight Mode. Same names. |
